...
class SymbolNameListForm(django.forms.Form):
    ...
    target_stock = django.forms.ChoiceField(label="選択してください", choices=symbol_name_tuple, required=False)


# 選択した銘柄のシンボルを保存するためのフォームクラス作成
class StockForm(django.forms.ModelForm):
    class Meta:
        model = Stock
